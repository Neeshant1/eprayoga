        ...
        return false;
         ...
         // var actual_end_time = aethh +':'+ aetmm +':'+ aetss;
            ...
            var scheduleData = {
                  ...
                  "promo_master_id" : this.promoId,
                  "order_detail_id" : this.odId,
                  "exam_planned_date"  : $('#exam_date').val(),
                  "start_time" : start_time,
                  "end_time" : end_time,
                  "product_catalog_id" : this.prodId

                 
      };

      //scheduleData.order_detail_id = 1;
     // alert(this.examScheduleId);
