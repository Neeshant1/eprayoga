...
user.PerformaPageView= Backbone.View.extend({
	...
	events : {
		...
		'click #useronegeneratepdf' :'useronegeneratePDF1',
	  ...
	  // requestData['quantity'] = JSON.parse(user.UserAppRouter.data);
	            ...
	            $.ajax({
	                ...
	                success: function(data1) {
	                 ...
	                 $('#generatepdf2').bind('click', self.useronegeneratePDF1);
	                 var date1 = new Date();
	...
	useronegeneratePDF1:function(){
			    usergeneratePDF();
			    $('#generatepdf2').hide();
			    $('#useronegeneratepdf').hide();
	},
