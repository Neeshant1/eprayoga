                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="header-top-left">
                                    <div class="logo-area">
                                        <a href="/"><img class="img-responsive" src="js/img/logo.png" alt="logo"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                <nav id="desktop-nav" style="margin-right: 450px;">
                                    <ul>
                                         ...
                                         <li><a href="/shopCart" id="shop1">Offering</a></li>
     
                                         <li><a href="" id="shop1"></a></li>
            ...
            <div class="col-md-12" style="margin-top: -120px;">
              <div class="widget">
                <div class="widget-heading" style="text-align: left;">
                  <h3 class="widget-title">Registration Successfull</h3>
                </div>
                <div class="widget-body">
                 
                  
                  <div class="well well-lg" style="text-align: left;">Please check your mail, password reset link sent your registered Email Id.</div>
                  <div align="left">
                  <a href="/" target="_self" > Please click here to login</a>
                  </div>
                </div>
              </div>
            </div>
